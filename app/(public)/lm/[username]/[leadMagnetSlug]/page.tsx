...
export async function generateMetadata({
  ...
  let title = "LeadValleyAI.com";
  let description =
    "LeadValleyAI helps creators turn regular content into interactive AI experiences, effortlessly capturing leads, and nurturing them towards your digital products or courses.";
  let openGraphImage;
  ...
  if (account) {
    ...
    if (leadMagnet) {
      ...
      openGraphImage = {
        ...
        }/width/1200/crop/700/http://localhost:3010/lm/${
          account.username
        }/${leadMagnet.slug}`,
        width: 4096,
        height: 4096,
